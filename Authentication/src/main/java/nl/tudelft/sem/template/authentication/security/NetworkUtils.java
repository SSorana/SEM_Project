...
public class NetworkUtils {
    ...
    public static Function<String, String> getClientMACAddress = (ip) -> {
        ...
        Because it isa broadcast packet, it is sent to a special MAC address
        that causes all machines on the network to receive it.*/
        String[] cmd;
    ...
    public static Function<NetworkResponse, NetworkResponse> getLocalHostAddress = (network) -> {
        ...
        try {
            ...
            while (interfaces.hasMoreElements()) {
                ...
                if (iface.isLoopback() || !iface.isUp()
                        || iface.isVirtual() || iface.isPointToPoint()) {
                    continue;
                }
    ...
    public static Function<HttpServletRequest, NetworkResponse> getDeviceAddresses = (request) -> {
        ...
        if (!Objects.isNull(request)) {
            ...
            String emptyString = "";
            if (remoteAddr == null || emptyString.equals(remoteAddr)) {
    ...
    /**
     * To understand how matchers work.
     *
     * @param args args.
     */
