...
public class ShellHelper {
    ...
    public transient String infoColor;

    @Value("${shell.out.success}")
    public transient String successColor;

    @Value("${shell.out.warning}")
    public transient String warningColor;

    @Value("${shell.out.error}")
    public transient String errorColor;
    ...
    public String getColored(String message, PromptColor color) {
        return (new AttributedStringBuilder())
                .append(message, AttributedStyle.DEFAULT.foreground(
                        color.toJlineAttributedStyle())).toAnsi();
    }
